    ...
    <main class="row">
        ...
        <section class="col d-flex flex-column">
            ...
            <div class="w-100 d-flex flex-column gap-2">
                <asp:TextBox ID="tbObservation" runat="server" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                <asp:Button ID="btnSaveObs" runat="server" Text="Guardar observación" CssClass="btn btn-primary"/>
            </div>
        </section>
    </main>
</asp:Content>
